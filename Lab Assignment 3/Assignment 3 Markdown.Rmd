---
title: "Lab Assignment 3 Markdown"
...
## Part 2 - Building Nested Models
### Part 2.1
In the above models I add a series of covariates that I believe could be potential confounders with age. In particular my first concern was that the relationship between age and coffee spending was potentially actually a result of a relationship between wealth and coffee spending. Wealth could predict age because older people have more time to develop in their careers and accumulate assets, and wealth could predict coffee spending as it provides a greater abillity to spend on coffee.
...
```{r Q1 Part 4, message = FALSE, warning = FALSE}
...
### Part 1.1
I created the binary indicator above.
### Part 1.2
I select race as the demographic predictor.
```{r Q2 Part 2.1}
### Part 2. OLS Modeling--------------------------------------------------------
